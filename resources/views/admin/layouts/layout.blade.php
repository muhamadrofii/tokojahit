...
{{-- </head> --}}
	{{-- <link href="https://cdn.jsdelivr.net/npm/simplebar@5.3.10/dist/simplebar.min.css" rel="stylesheet"> --}}
          ...
          <span class="align-middle">AdminKit</span>
			...
			{{-- main --}}
              ...
              <i class="align-middle" data-feather="plus"></i> <span class="align-middle">Create</span>
					...
					<li class="sidebar-item {{request()->routeIs('productattribute.review.manage')?'active':''}}">
						<a class="sidebar-link" href="{{route('productattribute.review.manage')}}">
              <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
            </a>
					</li>
